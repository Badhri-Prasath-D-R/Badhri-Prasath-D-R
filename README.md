...
class BadhriPrasath:
    def __init__(self):
        ...
        self.education   = "B.Tech AI & Data Science (Undergraduate)"
        self.passions    = ["AI/ML", "Full-Stack Dev", "Computer Vision", "System Design"]
        self.currently   = "Building scalable software + applied AI solutions"
...
- 💡 Passionate about **clean design & real-world AI impact**
- 🤝 Open to **collaborations, internships & open-source projects**
- 📫 Reach me at **badhriprasathdr@gmail.com**
- ⚡ Fun fact: **I build AI that can see 👁️ and systems that scale ⚙️**
